...
export function PengjackCard({ value, index }: PengjackCardProps) {
  ...
  return (
    <>
      ...
      `}</style>
      <div 
        className={`w-16 h-24 sm:w-20 sm:h-28 rounded-xl shadow-lg border-2 flex items-center justify-center text-xl sm:text-2xl font-black transition-transform hover:-translate-y-2 animate-card-deal ${
          isHidden 
